...
# Parse the FR day mode map: "home:Maison, work:Travail, remote:Télétravail, away:Absence"
...
def make_mock_entry(
    ...
    early_switch_minutes: int = DEFAULT_EARLY_SWITCH_MINUTES,
    ...
    entry.data = {
        ...
        CONF_EARLY_SWITCH_MINUTES: early_switch_minutes,
